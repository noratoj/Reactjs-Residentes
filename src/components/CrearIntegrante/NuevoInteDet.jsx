...
import ButtonGroup from '../Reactjs-Residentes-1/src/@material-ui/core/ButtonGroup';
...
import GroupFam from '../Reactjs-Residentes-1/src/components/DatBasRed/GroupFam';
...
export default function NuevoInte( { results, handleInputChange, ejecutarCreate } ) {
  ...
  return (
    ...
    <form className={classes.root} noValidate autoComplete="off">
      ...
      <div style={{float:'left', width:450, border:'1px solid red'}}>
      <h4>{"Datos Básicos Nuevo Integrante"}</h4>            
...
{/*             <FormHelperText>Label + placeholder</FormHelperText> */}
      ...
      <ButtonGroup variant="contained" color="primary" aria-label="contained primary button group">
        <Button onClick={(e)=>ejecutarCreate(e)}>Grabar</Button>
